...
void CScreenChapter::OnDoneButtonClick()
{
    ...
    case 3:
        ...
        if (g_pChitin->cNetwork.m_bConnectionEstablished == 1) {
            ...
            g_pBaldurChitin->m_cBaldurMessage.field_7 = 0;
        }
...
void CScreenChapter::StartChapterMultiplayerHost(BYTE nChapter, BYTE* resRef)
{
    ...
    BOOLEAN bJoinRequests = g_pBaldurChitin->m_pObjectGame->m_multiplayerSettings.m_bJoinRequests;
    g_pBaldurChitin->m_pObjectGame->m_multiplayerSettings.SetListenToJoinOption(FALSE, TRUE);
