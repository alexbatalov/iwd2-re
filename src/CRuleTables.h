...
public:
    ...
    /* 1468 */ C2DArray m_tCLABFI05;
    /* 148C */ C2DArray m_tCLABBA01;
    /* 14B0 */ C2DArray m_tCLABPR01;
    /* 14D4 */ C2DArray m_tCLABCL01;
    /* 14F8 */ C2DArray m_tCLABCL02;
    /* 151C */ C2DArray m_tCLABCL03;
    /* 1540 */ C2DArray m_tCLABCL04;
    /* 1564 */ C2DArray m_tCLABCL05;
    /* 1588 */ C2DArray m_tCLABCL06;
    /* 15AC */ C2DArray m_tCLABCL07;
    /* 15D0 */ C2DArray m_tCLABCL08;
    /* 15F4 */ C2DArray m_tCLABCL09;
    /* 1618 */ C2DArray m_tCLABDR01;
    /* 163C */ C2DArray m_tCLABFI01;
    /* 1660 */ C2DArray m_tCLABMO01;
    /* 1684 */ C2DArray m_tCLABPA01;
    /* 16A8 */ C2DArray m_tCLABRN01;
    /* 16CC */ C2DArray m_tCLABTH01;
    /* 16F0 */ C2DArray m_tCLABSR01;
    /* 1714 */ C2DArray m_tCLABMA01;
