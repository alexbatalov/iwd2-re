#ifndef CGAMEANIMATIONTYPEMONSTERLARGE_H_
#define CGAMEANIMATIONTYPEMONSTERLARGE_H_

#include "CGameAnimationType.h"
#include "CVidCell.h"

class CGameAnimationTypeMonsterLarge : public CGameAnimationType {
public:
    CGameAnimationTypeMonsterLarge(USHORT animationID, BYTE* colorRangeValues, WORD facing);
    /* 0000 */ ~CGameAnimationTypeMonsterLarge() override;
...
#endif /* CGAMEANIMATIONTYPEMONSTERLARGE_H_ */
